        ...
        if Graphics.key_pressed () then (
          let key = read_key () in if (testkeyrange key) then
            (var := getCaseCoord (fst !pos) (snd !pos) arraycasex arraycasey; messagevie true;encore := false;
            	dessineSelect !var true;	(*RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR*)
        	...
        	dessineSelect (getCaseCoord (fst !pos) (snd !pos) arraycasex arraycasey) true; (*RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR*)
        	pos := (Graphics.mouse_pos ());
        	dessineSelect (getCaseCoord (fst !pos) (snd !pos) arraycasex arraycasey) false (*RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR*)
        		) else () 
      end
    done
  done ;;
